...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('booking_bills', function (Blueprint $table) {
            ...
            $table->decimal('total_price', 10, 3)->nullable(); // Total price, 3 digits after decimal
            $table->decimal('total_discount', 10, 3)->nullable(); // Total discount
            $table->decimal('total_penalty', 10, 3)->nullable(); // Total penalty
            $table->decimal('grand_total', 10, 3)->nullable(); // Grand total after discounts/penalties
            $table->decimal('total_remaining', 10, 3)->nullable(); // Remaining amount

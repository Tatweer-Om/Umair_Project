...
@elseif ($controllerName == 'insurancecompany')
    {{-- Include the JavaScript file for adding size --}}
    @include('custom_js.add_insurance_company_js')
@elseif ($controllerName == 'color')
    @include('custom_js.add_color_js')
@elseif ($controllerName == 'car')
    @include('custom_js.add_car_js')
...
@elseif ($controllerName == 'customer_profile')
    @include('custom_js.customer_js')
@elseif ($controllerName == 'maint_car_all')
    @include('custom_js.add_car_js')
@elseif ($controllerName == 'car_profile')
    @include('custom_js.add_car_js')
@elseif ($controllerName == 'setting')
    @include('custom_js.setting_js')
@elseif ($controllerName == 'model')

                ...
                <div class="modal-body">
                    <form action="#" class="add_customer" method="POST" >
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div>
                                     <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" value="1" name="doc_type" id="id_card" checked="">
                                        <label class="form-check-label" for="id_card">
                                            {{ trans('messages.id_card_lang ',[],session('locale')) }}
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="2" name="doc_type" id="passport">
                                        <label class="form-check-label" for="passport">
                                            {{ trans('messages.passport_lang ',[],session('locale')) }}
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="id_no" class="form-label">{{ trans('messages.id_no_lang',[],session('locale')) }}</label>
                                    <input  class="form-control id_no " name="id_no" type="text" id="id_no">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="id_expiry" class="form-label">{{ trans('messages.id_expiry_lang',[],session('locale')) }}</label>
                                    <input  class="form-control id_expiry datepick" name="id_expiry" type="text" id="id_expiry">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="license_no" class="form-label">{{ trans('messages.license_no_lang',[],session('locale')) }}</label>
                                    <input  class="form-control license_no " name="license_no" type="text" id="license_no">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="license_expiry" class="form-label">{{ trans('messages.license_expiry_lang',[],session('locale')) }}</label>
                                    <input  class="form-control license_expiry datepick" name="license_expiry" type="text" id="license_expiry">
                                </div>
                            </div>
                        </div>
                        <div class="row">

...
class CustomerController extends Controller
{
    ...
    public function add_customer(Request $request){
        ...
        $customer->id_expiry = $request['id_expiry'];
        $customer->license_no = $request['license_no'];
        $customer->license_expiry = $request['license_expiry'];
    ...
    public function edit_customer(Request $request){
        ...
        $data = [
            ...
            'doc_type'  =>  $customer_data->doc_type,
            'id_no' => $customer_data->id_no,
            'id_expiry' => $customer_data->id_expiry,
            'license_no' => $customer_data->license_no,
            'license_expiry' => $customer_data->license_expiry,
